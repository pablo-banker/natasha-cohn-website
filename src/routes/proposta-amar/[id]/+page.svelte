<script lang="ts">
	...
	import { amarProposal } from '$lib/content/proposals';
...
<BrandIntro storageKey="natasha-intro-prop-amar-seen" onreveal={handleReveal} />

<div bind:this={contentEl}>
	<ProposalDocument content={amarProposal} budget={data.budget} />
</div>
